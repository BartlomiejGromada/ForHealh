...
export default function VisitDoctorCard({ doctorName, doctorProfession }: VisitDoctorCardProps) {
  const { t } = useTranslation();

  return (
    <View className="flex flex-row items-center bg-card-light dark:bg-card-dark p-4 rounded-lg gap-4">
